...
export function CatalogFilters({
  ...
  const clearAll = () =>
    onChange({ ordering: value.ordering });
  ...
  return (
    <div className={cn("flex flex-col gap-6", className)}>
      ...
      {hasFilters && (
        <button
          onClick={clearAll}
          className="flex items-center gap-1.5 rounded-lg border border-red-200 bg-red-50 px-3 py-2 text-xs font-semibold text-red-600 hover:bg-red-100 transition-colors w-full justify-center"
        >
